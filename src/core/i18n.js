...
const translations = {
    en: {
        ...
        countryAuto: 'Auto (detect from browser)',
        countrySection: 'Country (for public holidays)',
        countryDesc: 'Select your country to calculate public holidays and working days.',
    },
    pl: {
        loading: 'Ładowanie…',
        ...
        publicHolidays: 'Święta',
        workingDays: 'Dni robocze',
        daysOff: 'Dni wolne',
        countryLabel: 'Kraj',
        countryAuto: 'Auto (wykryj z przeglądarki)',
        countrySection: 'Kraj (dla świąt publicznych)',
        countryDesc: 'Wybierz kraj, aby obliczyć święta publiczne i dni robocze.',
    },
    de: {
        loading: 'Laden…',
        ...
        daysOff: 'Freie Tage',
        countryLabel: 'Land',
        countryAuto: 'Auto (aus Browser erkennen)',
        countrySection: 'Land (für Feiertage)',
        countryDesc: 'Wähle dein Land, um Feiertage und Arbeitstage zu berechnen.',
    },
    es: {
        loading: 'Cargando…',
        ...
        daysOff: 'Días libres',
        countryLabel: 'País',
        countryAuto: 'Auto (detectar del navegador)',
        countrySection: 'País (para festivos)',
        countryDesc: 'Selecciona tu país para calcular los festivos y días laborables.',
    },
    fr: {
        loading: 'Chargement…',
        ...
        countryLabel: 'Pays',
        countryAuto: 'Auto (détecter du navigateur)',
        countrySection: 'Pays (pour les jours fériés)',
        countryDesc: 'Sélectionnez votre pays pour calculer les jours fériés et ouvrés.',
    },
    ko: {
        loading: '로딩 중…',
        daysRemaining: '일 남음',
        ...
        daysOff: '휴일',
        countryLabel: '국가',
        countryAuto: '자동 (브라우저에서 감지)',
        countrySection: '국가 (공휴일용)',
        countryDesc: '공휴일과 근무일을 계산할 국가를 선택하세요.',
    },
    zh: {
        loading: '加载中…',
        daysRemaining: '天剩余',
        ...
        daysOff: '休息日',
        countryLabel: '国家',
        countryAuto: '自动（从浏览器检测）',
        countrySection: '国家（用于公共假日）',
        countryDesc: '选择您的国家以计算公共假日和工作日。',
    },
};
